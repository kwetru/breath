...
import 'package:breath/src/timer/timer5minute.dart';

void main() {
  runApp(const FiveMinuteTime());
}

class FiveMinuteTime extends StatelessWidget {
  const FiveMinuteTime({Key? key}) : super(key: key);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("five minute timer", style: TextStyle(
            fontSize: 25,
